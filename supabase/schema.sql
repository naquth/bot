...
-- FITUR: AKUN PRIVAT
-- ============================================================
-- Lihat penjelasan lengkap di supabase/migrations/add-private-accounts.sql
-- (isinya identik, diikutkan di sini juga supaya instalasi baru dari
-- schema.sql saja langsung mendapat fitur ini).
-- ============================================================
